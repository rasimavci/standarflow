          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                These Terms apply to all users of the Platform, including founders, investors, and visitors.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                ...
                publicly display, reproduce, and distribute such Content on and through the Platform.
              </p>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <li>The posting of your Content does not violate any rights of any third party</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <li>To interfere with or circumvent security features of the Platform</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                StandardFlow is a platform that facilitates connections between founders and investors. 
                We do not:
              </p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                <li>Provide investment advice or recommendations</li>
                <li>Act as a broker, dealer, or registered investment advisor</li>
                <li>Guarantee the success of any investment or startup</li>
                <li>Verify the accuracy of information provided by users</li>
              </ul>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mt-4">
                All investment decisions are made at the sole discretion and risk of the investor. 
                You should conduct your own due diligence and consult with professional advisors.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                functionality are and will remain the exclusive property of StandardFlow and its licensors. 
                The Platform is protected by copyright, trademark, and other laws.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                In no event shall StandardFlow, nor its directors, employees, partners, agents, suppliers, 
            ...
            <section className="mb-8">
              ...
              <ul className="list-none text-gray-600 dark:text-gray-300 space-y-2">
                <li>Email: legal@standardflow.com</li>
