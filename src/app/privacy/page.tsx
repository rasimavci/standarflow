          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 mb-4">
                ...
                <li>Create a founder or investor profile</li>
                <li>Upload documents (such as pitch decks or business plans)</li>
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <li>Financial information related to fundraising</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                ...
                <li>To match founders with appropriate investors</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
                <li><strong>With other users:</strong> Profile information visible to matched users</li>
                <li><strong>With service providers:</strong> Third parties who assist in platform operations</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-none text-gray-600 dark:text-gray-300 space-y-2">
                <li>Email: privacy@standardflow.com</li>
